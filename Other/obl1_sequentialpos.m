...
%     
%     
%     for b=1:28   % remember to get rid of the place-filler zeros before comparing
...
%%%%
% Figure 7: 1-2 occuring in 1, 2 or 3 or 4 (precedented by easy vs hard
% condition) - mean measures
figure(7)
subplot(2,3,1)
...
figure(8)
subplot(2,3,1)
bar([nanmean(seq_ef_1_mdev), nanmean(seq_ef_2_easy_mdev), nanmean(seq_ef_3_easy_mdev),...
    nanmean(seq_ef_4_easy_mdev), nanmean(seq_ef_2_hard_mdev),...
      nanmean(seq_ef_3_hard_mdev),...
     nanmean(seq_ef_4_hard_mdev)]);
xlab={'1', '2-easy','3-easy','4-easy', '2-hard','3-hard', '4-hard'}; 
xlabel('condition');
set(gca,'xticklabel',xlab);
ylabel('m-deviance');
...
subplot(2,3,2)
bar([nanmean(seq_ef_1_edev), nanmean(seq_ef_2_easy_edev),nanmean(seq_ef_3_easy_edev),...
    nanmean(seq_ef_4_easy_edev), nanmean(seq_ef_2_hard_edev),...
      nanmean(seq_ef_3_hard_edev), ...
     nanmean(seq_ef_4_hard_edev)]);
xlab={'1', '2-easy','3-easy','4-easy', '2-hard','3-hard', '4-hard'}; 
set(gca,'xticklabel',xlab);
ylabel('e-deviance');
...
subplot(2,3,3)
bar([nanmean(seq_ef_1_mrrt), nanmean(seq_ef_2_easy_mrrt),nanmean(seq_ef_3_easy_mrrt),...
    nanmean(seq_ef_4_easy_mrrt), nanmean(seq_ef_2_hard_mrrt),...
      nanmean(seq_ef_3_hard_mrrt), ...
     nanmean(seq_ef_4_hard_mrrt)]);
xlab={'1', '2-easy','3-easy','4-easy', '2-hard','3-hard', '4-hard'};  
xlabel('condition');
set(gca,'xticklabel',xlab);
...
subplot(2,3,4)
bar([nanmean(seq_ef_1_errt), nanmean(seq_ef_2_easy_errt), nanmean(seq_ef_3_easy_errt),...
    nanmean(seq_ef_4_easy_errt), nanmean(seq_ef_2_hard_errt),...
      nanmean(seq_ef_3_hard_errt),...
     nanmean(seq_ef_4_hard_errt)]);
xlab={'1', '2-easy','3-easy','4-easy', '2-hard','3-hard', '4-hard'}; 
xlabel('condition');
set(gca,'xticklabel',xlab);
...
subplot(2,3,5)
bar([nanmean(seq_ef_1_mprt), nanmean(seq_ef_2_easy_mprt), nanmean(seq_ef_3_easy_mprt),...
    nanmean(seq_ef_4_easy_mprt),nanmean(seq_ef_2_hard_mprt),...
     nanmean(seq_ef_3_hard_mprt),...
     nanmean(seq_ef_4_hard_mprt)]);
xlab={'1', '2-easy','3-easy','4-easy', '2-hard','3-hard', '4-hard'}; xlabel('condition');
set(gca,'xticklabel',xlab);
ylabel('mprt');


subplot(2,3,6)
bar([nanmean(seq_ef_1_eprt), nanmean(seq_ef_2_easy_eprt), nanmean(seq_ef_3_easy_eprt),...
    nanmean(seq_ef_4_easy_eprt),nanmean(seq_ef_2_hard_eprt),...
      nanmean(seq_ef_3_hard_eprt),...
     nanmean(seq_ef_4_hard_eprt)]);
xlab={'1', '2-easy','3-easy','4-easy', '2-hard','3-hard', '4-hard'}; 
xlabel('condition');
set(gca,'xticklabel',xlab);
